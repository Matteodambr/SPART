function isSingular = singularity_check_vectorized(H0, H0m, J0ee, Jmee, PARAM_Chaser)
...
% Instead of computing all singular values with svd, we compute the
% minimum eigenvalue of jstar'*jstar.
eigenValues = eig(jstar' * jstar) ;
minSingularVal = sqrt(max(0, min(eigenValues))) ;
