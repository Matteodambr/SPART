 ...
 * only. Not for sale.
 *
 * DiffKinematics_emxutil.c
 *
 * Code generation for function 'DiffKinematics_emxutil'
 *
 */
...
void emxFreeStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct)
{
  ...
  emxFree_struct1_T(sp, &pStruct->links);
  emxFree_struct2_T(sp, &pStruct->joints);
  emxFreeStruct_struct4_T(sp, &pStruct->con);
}

void emxFreeStruct_struct4_T(const emlrtStack *sp, struct4_T *pStruct)
{
  emxFree_real_T(sp, &pStruct->branch);
  emxFree_real_T(sp, &pStruct->child);
  emxFree_real_T(sp, &pStruct->child_base);
}
...
void emxInitStruct_struct0_T(const emlrtStack *sp, struct0_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_char_T(sp, &pStruct->name, srcLocation);
  emxInit_struct1_T(sp, &pStruct->links, srcLocation);
  emxInit_struct2_T(sp, &pStruct->joints, srcLocation);
  emxInitStruct_struct4_T(sp, &pStruct->con, srcLocation);
}

void emxInitStruct_struct4_T(const emlrtStack *sp, struct4_T *pStruct,
                             const emlrtRTEInfo *srcLocation)
{
  emxInit_real_T(sp, &pStruct->branch, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->child, 2, srcLocation);
  emxInit_real_T(sp, &pStruct->child_base, 1, srcLocation);
}
...
/* End of code generation (DiffKinematics_emxutil.c) */
