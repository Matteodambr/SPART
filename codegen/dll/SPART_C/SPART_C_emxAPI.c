 ...
 */
emxArray_cell_wrap_1 *emxCreateND_cell_wrap_1(int numDimensions,
                                              const int *size)
{
  ...
  emx->data = (cell_wrap_1 *)malloc((unsigned int)numEl * sizeof(cell_wrap_1));
 ...
 */
emxArray_cell_wrap_2 *emxCreateND_cell_wrap_2(int numDimensions,
                                              const int *size)
{
  ...
  emx->data = (cell_wrap_2 *)malloc((unsigned int)numEl * sizeof(cell_wrap_2));
  emx->numDimensions = numDimensions;
  emx->allocatedSize = numEl;
  return emx;
}
 ...
 * Return Type  : emxArray_cell_wrap_1 *
 */
emxArray_cell_wrap_1 *emxCreateWrapperND_cell_wrap_1(cell_wrap_1 *data,
                                                     int numDimensions,
                                                     const int *size)
{
  emxArray_cell_wrap_1 *emx;
 ...
 * Return Type  : emxArray_cell_wrap_2 *
 */
emxArray_cell_wrap_2 *emxCreateWrapperND_cell_wrap_2(cell_wrap_2 *data,
                                                     int numDimensions,
                                                     const int *size)
{
  emxArray_cell_wrap_2 *emx;
...
emxArray_cell_wrap_1 *emxCreate_cell_wrap_1(int rows, int cols)
{
  ...
  rows *= cols;
  emx->size[1] = cols;
  emx->data = (cell_wrap_1 *)malloc((unsigned int)rows * sizeof(cell_wrap_1));
  emx->numDimensions = 2;
...
emxArray_cell_wrap_2 *emxCreate_cell_wrap_2(int rows, int cols)
{
  ...
  rows *= cols;
  emx->size[1] = cols;
  emx->data = (cell_wrap_2 *)malloc((unsigned int)rows * sizeof(cell_wrap_2));
  emx->numDimensions = 2;
  emx->allocatedSize = rows;
  return emx;
}
 ...
 * Return Type  : void
 */
void emxInitArray_cell_wrap_1(emxArray_cell_wrap_1 **pEmxArray,
                              int numDimensions)
{
 ...
 * Return Type  : void
 */
void emxInitArray_cell_wrap_2(emxArray_cell_wrap_2 **pEmxArray,
                              int numDimensions)
{
...
/*
 * File trailer for SPART_C_emxAPI.c
 *
 * [EOF]
 */
